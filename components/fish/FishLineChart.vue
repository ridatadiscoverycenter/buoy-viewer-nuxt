    ...
    baseSpec() {
      return {
        ...
        marks: [
          ...
          this.locationSpec('Fox Island', 'height * 3 / 4', 'Year'),
        ],
      };
    },
  },
  methods: {
    locationSpec(location, ySpec, xAxisTitle) {
      return {
        type: 'group',
        ...
        axes: [
          { orient: 'bottom', scale: 'xscale', title: xAxisTitle },
          {
            orient: 'left',
            scale: 'ytemps',
            title: `°C Δ from Mean (${location})`,
            grid: false,
          },
        ],
