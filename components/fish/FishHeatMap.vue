      ...
      return {
        ...
        scales: [
          ...
          },
          {
            ...
            domain: ['fish', 'notfish'],
            range: [
              'm1.7 1c-1.125 0-2.107.685-2.653 1.27v0l-1.092-.826c-.152-.115-.378.008-.339.183v0l.302 1.372-.302 1.372c-.039.176 .188.298 .339.183v0l1.092-.826c.547.586 1.529 1.27 2.654 1.27 1.718 0 3.111-1.6 3.111-2 0-.4-1.393-2-3.111-2zm1.093 2.3c-.166 0-.3-.134-.3-.3 0-.166.134-.3.3-.3.166 0 .3.134 .3.3 0 .166-.134.3-.3.3z',
